...
const SingleRoom = () => {
  ...
  const { data, error, loading } = useFetch(
    `https://naikap-node-api.onrender.com/room/find/${id}`
  );
...
<div className="flex flex-col justify-between gap-8 md:flex-row md:max-w-[1340px] md:w-full md:justify-between md:rounded-[30px] md:mx-auto md:gap-7 md:mt-8 text-black h-[60vh] rounded-[30px]">   <div className="flex flex-col justify-center gap-4 p-8 mx-6 bg-gray-200 md:flex-col md:gap-3 md:bg-gray-200 md:text-black w-full md:w-full md:py-8 md:px-4">
     <div className="h-5 bg-gray-300 rounded mb-4 w-3/4"></div>
     <div className="h-5 bg-gray-300 rounded mb-4 w-2/4"></div>
     <div className="h-5 bg-gray-300 rounded mb-4 w-1/2"></div>
     <div className="h-5 bg-gray-300 rounded mb-4 w-full"></div>
     <div className="h-5 bg-gray-300 rounded mb-4 w-1/3"></div>
     <div className="h-5 bg-gray-300 rounded mb-4 w-2/3"></div>
  ...
  <div className="w-full">
    <div className="flex flex-col justify-between gap-8 md:flex-row md:max-w-[1340px] md:justify-between md:mx-auto md:gap-7 md:mt-8 text-black h-[60vh]">
      <img
        src={data?.roomById?.images?.url}
        className=" md:flex md:w-[75%] md:object-cover"
        alt=""
      />
 <div className="flex flex-col justify-center gap-4 p-8 mx-6 bg-gray-200 md:flex-col md:gap-3 md:bg-gray-200 md:text-black md:w-[25%] md:py-8 md:px-4 relative">
  ...
  <span
    className="bg-white text-black p-2 flex justify-between items-center rounded cursor-pointer"
  ...
  {openCalendar && (
    <div className="absolute top-60 left-0 mt-2 z-10 bg-white rounded shadow-lg w-full">
      <DateRange
  ...
  <div className="flex justify-between">
    ...
    <div className="flex justify-between gap-2">
      <button
        className="px-2 rounded border border-gray-400 hover:cursor-pointer"
        onClick={() => handleSumbit("adult", "d")}
  ...
  <div className="flex justify-between">
    ...
    <div className="flex justify-between gap-2">
      <button
        className="px-2 rounded border border-gray-400 hover:cursor-pointer"
        onClick={() => handleSumbit("children", "d")}
      ...
      <button
        className="px-2 rounded border border-gray-400 hover:cursor-pointer"
        onClick={() => handleSumbit("children", "i")}
      >
        +
      </button>
    </div>
  ...
  <button
    className="bg-green-85bc22 p-2 rounded hover:bg-white hover:transition hover:delay-150 hover:ease-in-out"
    onClick={handleClick}
  >
    Book Now
  </button>
    ...
    <div className="flex flex-col gap-3 justify-center items-center mt-64 w:full md:flex-row md:max-w-[1340px]  md:justify-between md:mt-8 md:mx-auto md:gap-7 ">
      ...
      <div className="flex flex-col gap-3 p-4 h-full bg-gray-200 mx-3 md:rounded-lg md:flex-col md:justify-center md:gap-1  md:bg-gray-200 rounded-lg md:w-[25%] md:min-h-[200px] md:p-4">
        ...
        <span>
          ...
          natus inventore similique magni maiores labore sunt explicabo non
          nesciunt eos?
        </span>
      </div>
    </div>
